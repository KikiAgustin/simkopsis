...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2021 at 03:22 AM
...
(1, 'Liani Kuspita', '', 'Bandung', '1999-06-16', '3204352103052378', 'Islam', 'keke', 'Jl. Cibaduyut lama No. 57A Kota Bandung jawa Barat', 'Mahasiswa', 'SMA', 'lajang', '086665444556', 'liani@gmail.com', 0, '{\"ktp\":\"IMG_20180912_123840.jpg\",\"kk\":\"sertifikat.jpg\",\"listrik\":\"Currikulum_Vitae.jpg\",\"jaminan\":\"Currikulum_Vitae.jpg\",\"kerja\":\"Currikulum_Vitae.jpg\",\"gaji\":\"Currikulum_Vitae.jpg\",\"rekening\":\"Currikulum_Vitae.jpg\"}', '2021-06-16 00:00:00');
...
(1, 1, 100000, '2021-06-16 06:36:10');
...
(1, 1, 'tabungan-bisnis', 10000000, 'TABUNGAN BISNIS : Tabungan Bisnis :  Mempersembahkan Tabungan Bisnis yang memberikan segala kemudahan dan kenyamanan.', '2021-06-16 06:33:38');
...
INSERT INTO `tbl_data_pinjaman` (`id_data_pinjaman`, `id_anggota`, `email`, `jenis_pinjaman`, `jumlah_pinjaman`, `jumlah_angsuran`, `tanggal`, `persetujuan`, `status`) VALUES
(1, 1, 'liani@gmail.com', 'Kredit Usaha Mikro', 10000000, 1, '2021-06-16 00:00:00', 0, 0);
...
(1, 1, 'Tabungan Bisnis', 'BANKKU Debit Bisnis Gold', 'Menabung', 'IMG_20180912_123840.jpg', 0);
...
CREATE TABLE `tbl_persyaratan` (
  ...
  `foto_kk` varchar(120) NOT NULL,
  `foto_npwp` varchar(120) NOT NULL,
  `foto_siup` varchar(120) NOT NULL,
  `foto_tabungan` varchar(120) NOT NULL,
  `status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_persyaratan` (`id_persyaratan`, `id_anggota`, `foto_ktp`, `foto_kk`, `foto_npwp`, `foto_siup`, `foto_tabungan`, `status`) VALUES
(1, 1, 'tp.jpg', 'IMG_20180912_125347.jpg', 'npwp.jpg', 'npwp1.jpg', 'npwp1.jpg', 0);
...
(1, 'Liani Kuspita', 'liani@gmail.com', 'default.png', '$2y$10$NDyX6W8PdEqgj4lzJFgiteoKw89yZMceXBCd4ghyKuhZh3xKDCnO6', 1623799814, 1, 2);

        ...
        <div class="card">
            <div class="card-content margin" style="margin: 12px;">
                <div class="row">
                    <div class="col s6 m6 l6">
                        <h4 class="cardbox-text light left margin">Deposito Rupiah</h4>
                    </div>
                    <!--                    <div class="col s6 m6 l6">-->
            ...
            <table class="bordered" id="barang-table">
                ...
                <tbody>
                    <?php
                    $no  = 1;
                    foreach ($aqikahQurban  as $key => $value) :
                        if ($value['simpanan_jenis'] === 'kurban') :
                    ?>
                            <tr>
    ...
    <div class="modal-content center">
        <div class="row">
            <div class="col s12 m12 center">
                <h5 class="more-text">tambah data Tabungan </h5>
                <h5 class="divider"></h5>
            </div>
            ...
            <div class="col s12 m12 ">
                <div id="simpanan-alert" class="card green lighten-5 z-depth-1">
                    <div class="card-content green-text ">
                        <p>Deposito Rupiah : Dapatkan Suku bunga Mandiri Deposito yang kompetitif menjadikan investasi Anda lebih cepat berkembang.</p>
                    </div>
                </div>
            </div>

			...
			<div class="card-content margin" style="margin: 12px;">
				<div class="row">
					<div class="col s6 m6 l6">
						<h4 class="cardbox-text light left margin">Kredit Modal Kerja UMKM</h4>
					</div>
					<!--                    <div class="col s6 m6 l6">-->
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td class="grey-text text-darken-1"><?= number_format($value['pinjaman_total']); ?></td>
							<td class="grey-text text-darken-1">
							...
							?>
									<td>
										<div class="row">
											...
											<a href="<?= base_url('pinjaman/setuju/' . $value['pinjaman_id']) ?>" class="btn-flat waves-effect waves-green col l6 center" title="setujui pengajuan">

            ...
            <div class="card-content margin" style="margin: 12px;">
                <div class="row">
                    <div class="col s6 m6 l6">
                        <h4 class="cardbox-text light left margin">Angsuran Kredit Usaha Mikro</h4>
                    </div>
                    <!--                    <div class="col s6 m6 l6">-->
            ...
            <table class="bordered" id="barang-table">
                ...
                <tbody>
                    ...
                    foreach ($murabahah as $key => $value) :
                        if ($value['pinjaman_jenis'] === 'murabahah') :
                    ?>
                            <tr>
    ...
    <div class="modal-content center">
        <div class="row">
            <div class="col s12 m12 center">
                <h5 class="more-text">tambah data angsuran kredit usaha mikro</h5>
                <h5 class="divider"></h5>
            </div>
